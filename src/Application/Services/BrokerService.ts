...
export class RabbitMQService {
	...
	public async sendRabbitMQ(data: any): Promise<void> {
		try {
			...
			// const result = await channel.assertQueue("checkin-realizado-v2");
			const parsedData = {
				...
				"destinationAddress": "rabbitmq://20.169.83.87/Sharedkernel.IntegrationEvents:VentaRegistrada",
				...
				"messageType": [
					...
					"urn:message:Sharedkernel.IntegrationEvents:VentaRegistrada",
			...
			channel.sendToQueue("checkin-realizado-v2", Buffer.from(JSON.stringify(parsedData)))
		}
		catch (e){
			console.error(e)
		}
